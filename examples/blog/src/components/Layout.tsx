            ...
            <body>
                <div className={cssMain({ display: "flex", flex_direction: "column", min_height: "100vh" })}>
                    ...
                    <main
                        className={cx(
                            container,
                            cssMain({ flex_grow: "1", padding_top: space(8), padding_bottom: space(8) }),
                            cssMd({ padding_top: space(12), padding_bottom: space(12) }),
                        )}
                    >
                        {children}
                    </main>
                    ...
                    <footer
                        className={cssMain({ border_top: `1px solid ${color.border}`, padding_top: space(6), padding_bottom: space(6), margin_top: space(8) })}
                    >
